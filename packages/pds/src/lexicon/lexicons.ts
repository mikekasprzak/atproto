...
export const schemaDict = {
  ...
  OrgW3ActivitypubActivity: {
    ...
    defs: {
      main: {
        ...
        ref: 'lex:org.w3.activitystreams.activity',
      },
    },
  },
  OrgW3ActivitypubActor: {
    ...
    defs: {
      main: {
        type: 'object',
        description: 'EXTENDS org.w3.activitystreams.actor, IMPLEMENTS actor',
      ...
      actorTypes: {
        type: 'ref',
        ref: 'lex:org.w3.activitystreams.actor#actorTypes',
      },
      endpointType: {
        type: 'ref',
      ...
      inbox: {
        type: 'ref',
        ref: 'lex:org.w3.activitypub.actor#endpointType',
      },
      outbox: {
        type: 'ref',
        ref: 'lex:org.w3.activitypub.actor#endpointType',
  ...
  OrgW3ActivitypubGetOutbox: {
    ...
    defs: {
      main: {
        type: 'query',
        description: "Fetches a user' outbox, in ActivityPub format",
        parameters: {
          type: 'params',
          required: ['repo'],
          properties: {
  ...
  OrgW3ActivitypubObject: {
    lexicon: 1,
    id: 'org.w3.activitypub.object',
    defs: {
      main: {
        type: 'object',
        description: 'EXTENDS org.w3.activitystreams.object, IMPLEMENTS object',
        properties: {
          '@context': {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.defs#contextType',
          ...
          type: {
            type: 'ref',
            ref: 'lex:org.w3.activitypub.object#objectTypes',
          },
          attachment: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#attachment',
  ...
  OrgW3ActivitystreamsActivity: {
    lexicon: 1,
    id: 'org.w3.activitystreams.activity',
    defs: {
      main: {
        type: 'object',
        description: 'EXTENDS object, IMPLEMENTS activity',
        properties: {
          '@context': {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.defs#contextType',
          ...
          type: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.activity#activityTypes',
          },
          attachment: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#attachment',
          ...
          actor: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#actor',
          },
          object: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#object',
          },
          target: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#target',
          },
          result: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#result',
          },
          origin: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#origin',
          },
          instrument: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#instrument',
          },
        },
      },
      activityTypes: {
  ...
  OrgW3ActivitystreamsActor: {
    lexicon: 1,
    id: 'org.w3.activitystreams.actor',
    defs: {
      main: {
        type: 'object',
        description: 'EXTENDS object, IMPLEMENTS actor',
        required: ['type'],
        properties: {
          '@context': {
            type: 'ref',
  ...
  OrgW3ActivitystreamsCollection: {
    lexicon: 1,
    id: 'org.w3.activitystreams.collection',
    defs: {
      main: {
        type: 'object',
        ...
        properties: {
          ...
          totalItems: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#totalItems',
          },
          current: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#current',
          },
          first: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#first',
          },
          last: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#last',
          },
          items: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#items',
          },
        },
      },
    },
  },
  OrgW3ActivitystreamsCollectionPage: {
    lexicon: 1,
    id: 'org.w3.activitystreams.collectionPage',
    defs: {
      main: {
        type: 'object',
        description: 'EXTENDS collection, IMPLEMENTS collectionPage',
        required: ['type'],
        properties: {
          '@context': {
            type: 'ref',
          ...
          partOf: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#partOf',
          },
          next: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#next',
          },
          prev: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#prev',
          },
        },
      },
    },
  ...
  OrgW3ActivitystreamsDefs: {
    ...
    defs: {
      contextType: {
        ...
        ref: 'lex:org.w3.activitystreams.defs#idOrArrayOfAndObject',
      },
      objectType: {
        type: 'ref',
        description:
      ...
      string: {
        type: 'string',
        description: 'xsd:string | rdf:langString',
      },
      anyURI: {
        type: 'string',
      ...
      idObject: {
        ...
        properties: {
          id: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.defs#id',
          },
        },
      },
      idTypeObject: {
      ...
      arrayOfStringObject: {
        ...
        items: {
          type: 'union',
          refs: [
            'lex:org.w3.activitystreams.defs#string',
      ...
      arrayOfIdObject: {
        ...
        items: {
          type: 'union',
          refs: [
            'lex:org.w3.activitystreams.defs#id',
            'lex:org.w3.activitystreams.defs#object',
          ],
        },
      },
      arrayOfStringArrayObject: {
        type: 'array',
        items: {
          type: 'union',
          refs: [
            'lex:org.w3.activitystreams.defs#string',
            'lex:org.w3.activitystreams.defs#arrayOfStringArrayObject',
            'lex:org.w3.activitystreams.defs#object',
          ],
        },
      },
      arrayOfAnyURIArrayObject: {
        type: 'array',
        items: {
          type: 'union',
          refs: [
            'lex:org.w3.activitystreams.defs#string',
            'lex:org.w3.activitystreams.defs#arrayOfAnyURIArrayObject',
            'lex:org.w3.activitystreams.defs#object',
          ],
        },
      },
      arrayOfIdArrayObject: {
        type: 'array',
        items: {
          type: 'union',
          refs: [
            'lex:org.w3.activitystreams.defs#string',
            'lex:org.w3.activitystreams.defs#arrayOfIdArrayObject',
            'lex:org.w3.activitystreams.defs#object',
          ],
        },
      },
      ...
      stringOrArrayOf: {
        ...
        refs: [
          'lex:org.w3.activitystreams.defs#string',
          'lex:org.w3.activitystreams.defs#arrayOfString',
        ],
      },
      anyURIOrArrayOf: {
        type: 'union',
        refs: [
          'lex:org.w3.activitystreams.defs#anyURI',
          'lex:org.w3.activitystreams.defs#arrayOfAnyURI',
        ],
      },
      idOrArrayOf: {
        type: 'union',
        refs: [
          'lex:org.w3.activitystreams.defs#id',
          'lex:org.w3.activitystreams.defs#arrayOfId',
        ],
      },
      stringOrArrayOfAndObject: {
        type: 'union',
        refs: [
          'lex:org.w3.activitystreams.defs#string',
          'lex:org.w3.activitystreams.defs#arrayOfStringObject',
          'lex:org.w3.activitystreams.defs#object',
        ],
      },
      anyURIOrArrayOfAndObject: {
        type: 'union',
        refs: [
          'lex:org.w3.activitystreams.defs#id',
      ...
      idOrArrayOfAndObject: {
        type: 'union',
        refs: [
          'lex:org.w3.activitystreams.defs#id',
          'lex:org.w3.activitystreams.defs#arrayOfIdObject',
          'lex:org.w3.activitystreams.defs#object',
        ],
      },
    },
  },
  OrgW3ActivitystreamsIntransitiveActivity: {
    lexicon: 1,
    id: 'org.w3.activitystreams.intransitiveActivity',
    defs: {
      main: {
        type: 'object',
        description: 'EXTENDS activity EXCLUDING #object',
        properties: {
          '@context': {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.defs#contextType',
    ...
    defs: {
      main: {
        ...
        properties: {
          ...
          type: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.link#linkTypes',
          },
          href: {
            type: 'ref',
  ...
  OrgW3ActivitystreamsOrderedCollection: {
    lexicon: 1,
    id: 'org.w3.activitystreams.orderedCollection',
    defs: {
      main: {
        type: 'object',
        description: 'EXTENDS collection, IMPLEMENTS orderedCollection',
        required: ['type'],
        properties: {
          '@context': {
            type: 'ref',
  ...
  OrgW3ActivitystreamsOrderedCollectionPage: {
    lexicon: 1,
    id: 'org.w3.activitystreams.orderedCollectionPage',
    defs: {
      main: {
        type: 'object',
        description: 'EXTENDS collectionPage, IMPLEMENTS orderedCollectionPage',
        required: ['type'],
        properties: {
          '@context': {
            type: 'ref',
          ...
          startIndex: {
            type: 'ref',
            ref: 'lex:org.w3.activitystreams.properties#startIndex',
          },
        },
      },
    },
  },
  OrgW3ActivitystreamsProperties: {
    lexicon: 1,
    id: 'org.w3.activitystreams.properties',
    description: 'https://www.w3.org/TR/activitystreams-vocabulary/#properties',
    defs: {
      id: {
        type: 'string',
        description: '@id; Domain: Object | Link; Range: anyURI; Functional',
        format: 'uri',
      },
      type: {
        type: 'string',
        description: '@type; Domain: Object | Link; Range: anyURI',
        format: 'uri',
      },
      typeObject: {
        type: 'string',
...
export const ids = {
  ...
  OrgW3ActivitystreamsActor: 'org.w3.activitystreams.actor',
  OrgW3ActivitystreamsCollection: 'org.w3.activitystreams.collection',
  OrgW3ActivitystreamsCollectionPage: 'org.w3.activitystreams.collectionPage',
  OrgW3ActivitystreamsDefs: 'org.w3.activitystreams.defs',
  OrgW3ActivitystreamsIntransitiveActivity:
    'org.w3.activitystreams.intransitiveActivity',
